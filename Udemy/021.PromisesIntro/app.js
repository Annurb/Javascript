...
fakeRequestCallback('books.com/page1', function(response) {
    ...
    fakeRequestCallback('books.com/page2', function(response){
        ...
        console.log('it worked again(2n time)')
        console.log(response)
...
.then(() => {
    ...
    .then(() => {
        console.log('PROMISE RESOLVED( 2n)')
      console.log('IT WORKED!!!')
      fakeRequestPromise('yelp.com/api/coffee/page3')
      .then(()=>{
         console.log('PROMISE RESOLVED( 3n)')
      console.log('IT WORKED!!!')
      }).catch(() =>{
        console.log('PROMISE REJECTED(3n)')
    console.log('OH NO, ERROR!!!!')
      })
    }).catch(()=>{
        console.log('PROMISE REJECTED(2n)')
    console.log('OH NO, ERROR!!!!')
    })
}).catch(() => {
